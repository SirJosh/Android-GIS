...
\begin{document}
	...
	\begin{tabular}{|l|l|l|l|}
		...
		\textbf{Pass/Fail} & \textbf{Mark (10)} & \multicolumn{2}{l|}{\textbf{Reason}}                                                                                                                                                              \\ 
		\hline
		\cmark  &  0 & \multicolumn{2}{l|}{\begin{tabular}[c]{@{}l@{}}this is some text that is a lot of text can you -lease wraparound \\ so it omdfshjvafkdghjvnadhjkvbknadf\\vjh,kandfb vadfbadfbsf\end{tabular}} \\ \hline
	\end{tabular}
		...
		\end{tabular}
			...
			\end{tabular}
				...
				\begin{tabular}{|l|l|l|l|}
					...
					\textbf{Pass/Fail} & \textbf{Mark (10)} & \multicolumn{2}{l|}{\textbf{Reason}}                                                                                                                                                              \\ 
					\hline
					\cmark  &   0  & \multicolumn{2}{l|}{\begin{tabular}[c]{@{}l@{}}The mewthods allow for batch processing as opposed to one at a time which is \\ redundant with a module that recieves lots of data\\ \end{tabular}} \\ \hline
