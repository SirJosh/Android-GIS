...
\begin{center}
	\begin{minipage}{0.48\linewidth}
		\includegraphics[width=\linewidth]{test1.jpeg}
		\captionof{figure}{Test code for add location function}
	\end{minipage}
	\hfill
	\begin{minipage}{0.49\linewidth}
		\includegraphics[width=\linewidth]{pass1.jpeg}
...
\begin{center}
	\begin{minipage}{0.48\linewidth}
		\includegraphics[width=\linewidth]{test2.jpeg}
		\captionof{figure}{Test code for remove location function}
	\end{minipage}
	\hfill
	\begin{minipage}{0.49\linewidth}
		\includegraphics[width=\linewidth]{pass2.jpeg}
		\captionof{figure}{Result after test is run: status code 200}
	\end{minipage}
\end{center}
\pagebreak
...
\begin{center}
	\begin{minipage}{0.48\linewidth}
		\includegraphics[width=\linewidth]{test3.jpeg}
		\captionof{figure}{Test code for update function}
	\end{minipage}
	\hfill
	\begin{minipage}{0.49\linewidth}
		\includegraphics[width=\linewidth]{pass3.jpeg}
		\captionof{figure}{Result after test is run: status code 200}
	\end{minipage}
\end{center}
